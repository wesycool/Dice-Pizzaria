...
async function getWeatherAPI(){
    await fetch('/staff-portal/api/weather-key')
    .then(res => res.json())
...
function getLocation(units) {
    navigator.geolocation.getCurrentPosition(function(position){
        ...
        function displayData(data) {
            console.log(data);
            document.querySelector("#forecastBtn").innerHTML = `${data.main.temp} &deg;${conversion} <img src='http://openweathermap.org/img/wn/${data.weather[0].icon}.png' id='weatherIcon'>`;
